...
class FileGenerationSettings(BaseModel):
    primary_color: str = "#1a1a2e"
    accent_color: str = "#e94560"
    logo_url: str = ""
    footer_text: str = "Generated by Shift AI · Telfaz11"
    general_instructions: str = ""
    pdf_instructions: str = ""
    pptx_instructions: str = ""
    docx_instructions: str = ""
    html_instructions: str = ""


class FileGenerationSettingsUpdate(BaseModel):
    primary_color: Optional[str] = None
    accent_color: Optional[str] = None
    logo_url: Optional[str] = None
    footer_text: Optional[str] = None
    general_instructions: Optional[str] = None
    pdf_instructions: Optional[str] = None
    pptx_instructions: Optional[str] = None
    docx_instructions: Optional[str] = None
